...
public class ServicesDAOImpl implements ServicesDAO {
    ...
    public void tableFill() {
        ...
        if (list.isEmpty()) {
            ...
            UserEntity user4 = new UserEntity("user", "11", "userl1@mail", (short) 1, buildsEntity1);
            UserEntity user5 = new UserEntity("user2", "11", "userl2@mail", (short) 1, buildsEntity1);
            UserEntity user6 = new UserEntity("user3", "11", "userl3@mail", (short) 1, buildsEntity2);
            UserEntity user7 = new UserEntity("user4", "11", "userl4@mail", (short) 1, buildsEntity3);
