...
<div id="section1" class="container-fluid">
  <div class="container">
  <form role="form" enctype="multipart/form-data" class="form-vertical" action="/signup/add" method="post">
    <div><h3>Регистрация</h3></div>
    <div class="row form-control">
    <div class="col-xs-2"><input type="text" class="form-control" name="login" placeholder="Login"></div>
    </div>
    <div class="row">
    <div class="col-xs-2"><input type="password" class="form-control" name="pass" placeholder="Password"></div>
    </div>
    <div class="col-xs-3"><input type="email" class="form-control" name="email" placeholder="@Email"></div>
    <div><h4>Тип учетной записи:</h4>
    ...
    <div class="col-xs-4"><input type="text" class="form-control" name="key" placeholder="Secret Key"></div>
